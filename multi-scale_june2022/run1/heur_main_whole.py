...
def calcCost(subset, all_df):
    '''
    calculates the sum of costs of reservoirs in subset
    ** NOT USED
    '''
    pass
...
children0_df = h_gen.create_children3(parents0_df, None, num_subsets, num_subsets, resPolyg_df, 0, runFolder)
